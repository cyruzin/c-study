...
/*
        ...
        >> - Right Shift (Division by powers of 2: x >> y is equivalent to x / (2^y))
        << - Left Shift (Multiplication by powers of 2: x << y is equivalent to x * (2^y))
      ...
      unsigned int num = 8; // bit pattern 00001000
      unsigned int result = num >> 1; // bit pattern 00000100, which is 4
